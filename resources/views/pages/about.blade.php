...
@section('title', 'Tentang Kami | Anril Film Production')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-20">
            ...
            <p class="text-base sm:text-lg text-gray-400 font-light leading-relaxed">
                Anril Film hadir sebagai production house spesialis pembuatan video corporate profesional nasional yang mengedepankan kualitas sinematik papan atas dengan efisiensi biaya.
            </p>
        </div>
